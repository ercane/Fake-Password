...
import com.cardinalsolutions.countdowntimer.geed.util.Validator;
...
public class LauncherHomeActivity extends Activity{
     ...
     * also we can let user to choose a launcher from system laucher
     * and our custom launchers,"BaiDu"
     * lock screen app and "Go" lock screen app just do this.<br/>
     *
     * @param context
     */
        ...
        if (resInfoList != null) {
            ...
            for (int i = 0; i < resInfoList.size(); i++) {
                ...
                if ((resInfo.activityInfo.applicationInfo.flags &
                    ...
                    if ("com.sec.android.app.launcher".equals(resInfo.activityInfo.packageName)) {
